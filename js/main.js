...
$(document).ready(function() {
  ...
  themeToggle.addEventListener('click', function() {
    ...
    if (currentMode.includes('dark-mode')) {
      newTheme = 'light';
    } else if (currentMode.includes('light-mode')) {
      newTheme = 'dark';
    } else {
      newTheme = 'dark'; // default to dark if no mode detected
    }
    
    // Remove existing theme classes
    document.body.className = document.body.className.replace(/-mode/g, '');
    // Add new theme class
